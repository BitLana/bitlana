...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 64;
...
const uint32_t ZAWY_DIFFICULTY_BLOCK_INDEX                 = 7000;
const size_t ZAWY_DIFFICULTY_V2                          = 0;
const uint8_t ZAWY_DIFFICULTY_DIFFICULTY_BLOCK_VERSION   = 0;
const unsigned EMISSION_SPEED_FACTOR                         = 17;
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(3873816255479005700);
...
const char     CRYPTONOTE_NAME[]                             = "bitlana";
...
const int      P2P_DEFAULT_PORT                              =  24505;
const int      RPC_DEFAULT_PORT                              =  24506;
...
const char* const SEED_NODES[] = { "54.71.107.179:24505", "34.208.210.150:24505" };
